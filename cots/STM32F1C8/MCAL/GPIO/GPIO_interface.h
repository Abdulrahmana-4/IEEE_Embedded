...
STD_ReturnType Mcal_Gpio_SetPinMode(u8 Copy_Port_Id, u8 Copy_PinId, u8 Copy_PinMode);
...
STD_ReturnType Mcal_Gpio_SetPinValue(u8 Copy_Port_Id, u8 Copy_PinId, u8 Copy_PinValue);
